...
def cost_compra():
    ...
    col2.markdown('El cost de compra és de ** 10.800 €**')
...
def comparativa():
    ...
    valors=[[2800,10800],[2200,3571],[693,400]]
    ...
    valor=[10800/5,2800/2]
    amort=pd.DataFrame(valor,Columnes)
    st.write(amort)
    st.markdown("** Per igualar l'amortització de la serra pneumàtica cal 8 anys de la hidràulica **")
